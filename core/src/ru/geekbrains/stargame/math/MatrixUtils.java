...
public class MatrixUtils {
    ...
    public static void calcTransitionMatrix(Matrix4 mat, Rect src, Rect dst) {
        ...
        mat.idt().translate(dst.pos.x, dst.pos.y, 0f).scale(scaleX, scaleY, 1f).translate(-src.pos.x, -src.pos.y, 0f);//1. перемещаем в начало координат; 2. скалируем; 3. перемещаем
    }
